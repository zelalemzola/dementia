    ...
    >
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center gap-4 pb-4 border-b border-border">
          ...
          <div>
            <h3 className="font-semibold text-foreground">Cognitive Assessment Report</h3>
            <p className="text-sm text-muted-foreground">Complete Analysis Results</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          {[
            ...
            <div key={item.label} className="rounded-lg bg-secondary/50 p-4">
              ...
              <div className="text-2xl font-bold text-foreground">{item.value}/100</div>
            </div>
          ))}
        </div>
        ...
        <div className="space-y-3">
          ...
          {[85, 72, 68, 91, 77, 83].map((value, i) => (
            <div key={i} className="flex items-center gap-3">
              <div className="w-24 text-xs text-muted-foreground">Category {i + 1}</div>
              ...
              <div className="w-8 text-xs text-right text-muted-foreground">▓▓</div>
            </div>
          ))}
        </div>
