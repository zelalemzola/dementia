...
const plans = [
  {
    ...
    icon: Zap,
    features: [
      "Complete dementia risk assessment report",
      "Memory decline analysis breakdown",
      "Cognitive impairment score evaluation",
      "Basic dementia prevention recommendations",
      "PDF download",
    ],
    popular: false,
  },
  {
    ...
    features: [
      "Everything in Basic",
      "Detailed dementia risk assessment",
      "Personalized dementia prevention plan",
      "Executive function decline analysis",
      "Language processing impairment analysis",
      "Mood & behavioral changes insights",
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Choose Your Dementia Report Plan
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Select the plan that best fits your needs. All plans include your
            complete dementia risk assessment results delivered instantly to
            your email.
          </p>
        </motion.div>
