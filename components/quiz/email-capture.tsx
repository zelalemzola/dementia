          ...
          >
            ...
            <div>
              ...
              <h1 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
                Your Dementia Risk Report is Ready
              </h1>
              <p className=" text-muted-foreground">
                Enter your email to receive your detailed dementia risk
                assessment report. Your cognitive health analysis has been
                completed and is waiting for you.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                },
                {
                  ...
                  desc: "Report sent immediately",
                },
                {
                  icon: FileText,
                  label: "Dementia Risk Analysis",
                  desc: "Dementia risk assessment",
                },
                {
                  icon: Mail,
                  label: "PDF Format",
                  desc: "Easy to save & share",
                },
              ].map((feature) => (
                <div
                  key={feature.label}
            ...
            <div className="rounded-2xl border border-border bg-card p-4 space-y-4">
              ...
              >
                Unlock My Dementia Report
              </Button>

              <p className="text-xs text-center text-muted-foreground">
                By continuing, you agree to our Terms of Service and Privacy
                Policy. We will never share your email with third parties.
              </p>
            </div>
          </motion.div>
